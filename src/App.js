...
// import 'bootstrap/dist/js/bootstrap.bundle.min.js'; // Required for hamburger collapse
...
export default function App() {
  ...
  // const logintools = (username, password) => {
    ...
    <div style={{ backgroundColor: "#020D18" }}>
      <Router>
        ...
        <Switch>
          ...
          <Route
            path="/download/:id"
            component={isloggedin ? DownloadPage : Register}
          />
